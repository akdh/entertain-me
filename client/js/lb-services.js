  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Person#prototype$__findById__preferences
         * @methodOf lbServices.Person
         *
         * @description
         *
         * Find a related item by id for preferences
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        "prototype$__findById__preferences": {
         ...
         * @description
         *
         * Update a related item by id for preferences
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        "prototype$__updateById__preferences": {
          url: urlBase + "/people/:id/preferences/:fk",
          method: "PUT"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Person#prototype$__get__preferences
         * @methodOf lbServices.Person
         *
         * @description
         *
         * Queries preferences of person.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        /**
         * @ngdoc method
         * @name lbServices.Person#prototype$__create__preferences
         * @methodOf lbServices.Person
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Person#prototype$__count__preferences
         * @methodOf lbServices.Person
         *
         * @description
         *
         * Counts preferences of person.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        "prototype$__count__preferences": {
          url: urlBase + "/people/:id/preferences/count",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__findById__accessTokens
         ...
         */
        "prototype$__findById__accessTokens": {
          url: urlBase + "/services/:id/accessTokens/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__destroyById__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__updateById__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__findById__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__destroyById__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__get__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
         * Queries accessTokens of service.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/services/:id/accessTokens",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__create__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__delete__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__count__accessTokens
         * @methodOf lbServices.Service
         *
         * @description
         *
         * Counts accessTokens of service.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/services/:id/accessTokens/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__get__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
         * Queries subscriptions of service.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__subscriptions": {
          isArray: true,
          url: urlBase + "/services/:id/subscriptions",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__create__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__delete__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#prototype$__count__subscriptions
         * @methodOf lbServices.Service
         *
         * @description
         *
         * Counts subscriptions of service.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__count__subscriptions": {
          url: urlBase + "/services/:id/subscriptions/count",
          method: "GET"
        },
        ...
        "login": {
          ...
          url: urlBase + "/services/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#logout
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        "logout": {
          ...
          url: urlBase + "/services/logout",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#confirm
         * @methodOf lbServices.Service
         *
         * @description
         *
         ...
         */
        "confirm": {
          url: urlBase + "/services/confirm",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#resetPassword
         * @methodOf lbServices.Service
         *
         * @description
         *
         ...
         */
        "resetPassword": {
          url: urlBase + "/services/reset",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Service#getCurrent
         * @methodOf lbServices.Service
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#getCachedCurrent
         * @methodOf lbServices.Service
         *
         * @description
         *
         * Get data of the currently logged user that was returned by the last
         * call to {@link lbServices.Service#login} or
         * {@link lbServices.Service#getCurrent}. Return null when there
         * is no user logged in or the data of the current user were not fetched
         * yet.
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#isAuthenticated
         * @methodOf lbServices.Service
         *
         * @returns {boolean} True if the current user is authenticated (logged in).
         */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Service#getCurrentId
         * @methodOf lbServices.Service
         *
         * @returns {Object} Id of the currently logged-in user or null.
         */
